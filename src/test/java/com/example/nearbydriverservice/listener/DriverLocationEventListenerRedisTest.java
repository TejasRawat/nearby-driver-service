...
@ActiveProfiles("test")
@Slf4j
class DriverLocationEventListenerRedisTest extends AbstractIntegrationTest {

  @DynamicPropertySource
  static void configure(DynamicPropertyRegistry registry) {
    registry.add("driver.location.repository.type", () -> "redis");
  }
  ...
  void shouldStoreAllUniqueDriverLocationsAndReturnResults_whenEventsAreInserted() throws Exception {
    ...
    assertEntryInRedis(numberOfDocuments);
